...
@export var dialogue_text: String = "Mais um da pilha de ossos, quer sair daqui não quer? Eu vou te ajudar, coloque todas as alavancas para a esquerda e o baú se abrirá."
